...
export default function CounselNameSelector({ className = '' }: CounselNameSelectorProps) {
  const { selectedName, setSelectedName, availableNames } = useCounselName();
    ...
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown */}
          <div className="absolute top-full left-0 mt-1 bg-white border border-gray-200 rounded-md shadow-lg z-20 min-w-[200px] max-h-60 overflow-y-auto">
            <div className="p-2">
